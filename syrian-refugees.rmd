---
title: "GEOB472: Syrian Refugees Infographic"
...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, message = FALSE,
                      ...
                      dev = "svg",
                      fig.path = "figures/",
                      dpi = 96, fig.width = 480 / 96, fig.height = 480 / 96)
```
...
Original unprocessed datasets are available: https://github.com/kmacintosh/syrian-refugees/tree/master/data.

Intermediate datasets are available here: https://github.com/kmacintosh/syrian-refugees/tree/master/output.
...
```{r prop-refugees-by-destination, fig.width=800/96}
# stacked bar
...
```{r, fig.width=800/96, fig.height=600/96}
